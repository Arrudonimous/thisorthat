...
export default function Button({ title, loading }: ButtonProps) {
  ...
  return (
    <div role="status" className="flex justify-center py-2 items-center">
      <svg className="inline mr-2 w-9 h-9 text-gray-200 animate-spin dark:text-gray-600 fill-light" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
